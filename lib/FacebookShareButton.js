...
function (_Component) {
  ...
  _createClass(FacebookShareButton, null, [{
    key: "propTypes",
    get: function get() {
      return {
  ...
  function FacebookShareButton(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FacebookShareButton).call(this, props));
    _this.state = {
      initalized: false
    };
    return _this;
  ...
  _createClass(FacebookShareButton, [{
    ...
    value: function init() {
      ...
      var fbsharebutton = _reactDom.default.findDOMNode(this.refs.fbsharebutton);
