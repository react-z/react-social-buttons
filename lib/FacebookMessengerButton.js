...
var FacebookMessengerButton =
/*#__PURE__*/
function (_Component) {
  _inherits(FacebookMessengerButton, _Component);

  _createClass(FacebookMessengerButton, null, [{
    key: "propTypes",
    get: function get() {
      return {
  ...
  function FacebookMessengerButton(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FacebookMessengerButton).call(this, props));
    _this.state = {
      initalized: false
    };
    return _this;
  ...
  _createClass(FacebookMessengerButton, [{
    ...
    value: function init() {
      ...
      var fbsendbutton = _reactDom.default.findDOMNode(this.refs.fbsendbutton);
